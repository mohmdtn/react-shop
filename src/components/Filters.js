          ...
          <div className="form-control">
            ...
            <div>
              {categories.map((c, index) => {
                return <button key={index} onClick={updateFilters} name='category' className={`${category === c.toLowerCase() ? 'active' : 'null'}`}>{c}</button>
              })}
            </div>
          </div>
          ...
          <div className="form-control">
            ...
            <div className="colors">
              {colors.map((c, index) => {
                ...
                return <button key={index} name="color" className={`${color === c ? 'active color-btn' : 'color-btn'}`} onClick={updateFilters} data-color={c} style={{ backgroundColor: c }}>{color === c && <FaCheck />}</button>
              })}
            </div>
          </div>
